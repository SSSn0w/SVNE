    ...
    class StoryOptions {
        ...
        public static void Add(List<Option> options) {
            ...
            for (int i = 0; i < options.Count(); i++) {
                ...
                list.Add(new Button(options[i].Text, new Texture("Assets/game_option_background.png"),new Color(255, 255, 255), new Color(255, 0, 0), new Color(0, 255, 0), 30, new Font("Assets/Consolas.ttf"), 0, 100 * (i + 1), () => {
                    sceneJump.Jump();
                    return 0;
                }, true));
